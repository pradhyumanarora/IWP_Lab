    ...
    <body>
        ...
        <nav>
            <div id="navigation">
                ...
                <a href="workout3.php" class="active">Flexibility Training</a>
                <a href="workout4.php">Yoga</a>
                <a href="workout5.php">Pilates</a>
            </div>
        </nav>
        <h2 style="text-align: center; font-family: Satisfy, cursive;">Full- Body Flexibility Training made easy!</h2>
            ...
            * {
            ...
            <div class="container" >
                <div class="mySlides">
                    ...
                    <img src="images\warmup3.gif" style="width:60%; height:400px; display: block;margin-left: auto; margin-right: auto; ">
                </div>
                
                <div class="mySlides">
                    <div class="numbertext">2 / 6</div>
                    <img src="images\one3.gif" style="width:60%; height:400px;  display: block;margin-left: auto; margin-right: auto;">
                </div>
                
                <div class="mySlides">
                    <div class="numbertext">3 / 6</div>
                    <img src="images\two3.gif" style="width:60%; height:400px;  display: block;margin-left: auto; margin-right: auto;">
                </div>
                    
                <div class="mySlides">
                    <div class="numbertext">4 / 6</div>
                    <img src="images\three3.gif" style="width:60%; height:400px;  display: block;margin-left: auto; margin-right: auto;">
                </div>
                
                <div class="mySlides">
                    <div class="numbertext">5 / 6</div>
                    <img src="images\four3.gif" style="width:60%; height:400px;  display: block;margin-left: auto; margin-right: auto;">
                </div>
                    
                <div class="mySlides">
                    <div class="numbertext">6 / 6</div>
                    <img src="images\cool3.gif" style="width:60%; height:400px;  display: block;margin-left: auto; margin-right: auto;">
                </div>
