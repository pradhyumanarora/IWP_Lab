    ...
    <body>
        ...
        <nav>
            <div id="navigation">
                ...
                <a href="workout1.php" class="active" >Stretching</a>
        ...
        <h2 style="text-align: center; font-family: Satisfy, cursive;">Lower Body Stretch at Home with No Equipments for full-body strength!</h2>
            ...
            * {
            ...
            <div class="container" >
                <div class="mySlides">
                    ...
                    <img src="images\warmup2.gif" style="width:60%; height:400px; display: block;margin-left: auto; margin-right: auto; ">
                </div>
                
                <div class="mySlides">
                    <div class="numbertext">2 / 6</div>
                    <img src="images\one2.gif" style="width:60%; height:400px;  display: block;margin-left: auto; margin-right: auto;">
                </div>
                
                <div class="mySlides">
                    <div class="numbertext">3 / 6</div>
                    <img src="images\two2.gif" style="width:60%; height:400px;  display: block;margin-left: auto; margin-right: auto;">
                </div>
                    
                <div class="mySlides">
                    <div class="numbertext">4 / 6</div>
                    <img src="images\three2.gif" style="width:60%; height:400px;  display: block;margin-left: auto; margin-right: auto;">
                </div>
                
                <div class="mySlides">
                    <div class="numbertext">5 / 6</div>
                    <img src="images\four2.gif" style="width:60%; height:400px;  display: block;margin-left: auto; margin-right: auto;">
                </div>
                    
                <div class="mySlides">
                    <div class="numbertext">6 / 6</div>
                    <img src="images\cool2.gif" style="width:60%; height:400px;  display: block;margin-left: auto; margin-right: auto;">
                </div>
